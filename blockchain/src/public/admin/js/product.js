...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function formatDate(dateString) {
    return window.ProductManager.formatDate(dateString); // Sử dụng hàm từ feature.js
  }
  ...
  function initializePreview() {
    ...
    function updatePreview(field, value) {
      ...
      if (previewElement) {
        if (field === "price") {
          ...
          previewElement.textContent = new Intl.NumberFormat("vi-VN").format(
            value
          );
    ...
    productPriceInput.addEventListener("input", (e) =>
      updatePreview("price", e.target.value)
    );
    productDescInput.addEventListener("input", (e) =>
      updatePreview("description", e.target.value)
    );
    productUsesInput.addEventListener("input", (e) =>
      updatePreview("uses", e.target.value)
    );
    productProcessInput.addEventListener("input", (e) =>
      updatePreview("process", e.target.value)
    );
